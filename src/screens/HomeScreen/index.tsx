  ...
  return (
    ...
    <View style={styles.container}>
      ...
      <View style={{ alignItems: 'center', marginTop: 10 }} >
        <Text style={{ fontSize: 20, width: "80%", textAlign: "center" }} >Hey! What are you looking for? </Text>
      </View>
      ...
      <FlatList
        data={data}
        renderItem={({ item }) => (
          <TouchableOpacity style={styles.categoryContainer} onPress={handleCardPress}>
            <View style={styles.card}>
              <Text>{item.text}</Text>
            </View>
          </TouchableOpacity>
      ...
      >
        <View style={[styles.modalView, { height: modalHeight }]}>
          ...
          <TouchableOpacity
            ...
            style={{ width: '70%', height: 40, alignSelf: "center", position: "absolute", bottom: 20, backgroundColor: "orange", alignItems: "center", justifyContent: "center" }}
